...
export default function Create({
    ...
    return (
        ...
        >
            <Head title="Жер қойнауын пайдаланушыны құру" />

            <PageContainer width="standard">
                <PageHeader
                    eyebrow="Жер қойнауын пайдалану"
                    title="Жаңа жер қойнауын пайдаланушы"
                    subtitle="Лицензия деректерін, негізгі көрсеткіштерді және картадағы аумақты толтырыңыз."
                />
