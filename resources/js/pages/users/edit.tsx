    ...
    return (
        ...
        >
            ...
            <PageContainer width="form">
                <PageHeader
                    eyebrow="Пайдаланушылар"
                    title="Пайдаланушыны өңдеу"
                    subtitle="Аккаунттың байланыс деректерін, рөлін және аймақтық параметрлерін жаңартыңыз."
                />
                <FormCard>
                    <form onSubmit={submit} className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-xs text-gray-400">
                                Пайдаланушы ботқа /start жіберіп, Chat ID алуы
                                қажет
                            </p>
                        </div>
