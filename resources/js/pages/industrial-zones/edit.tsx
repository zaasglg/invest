...
export default function Edit({ industrialZone, regions }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        total_area: industrialZone.total_area || '',
        investment_total: industrialZone.investment_total || '',
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(industrialZones.update.url(industrialZone.id));
    };
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            <Head title="Редактирование ИЗ" />

            <div className="flex h-full flex-col p-4 max-w-2xl">
                <h1 className="text-2xl font-bold font-serif mb-6 text-neutral-900 dark:text-neutral-100">Редактирование ИЗ</h1>
                ...
                <form onSubmit={submit} className="flex flex-col gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link href={industrialZones.index.url()} className="text-sm text-neutral-500 hover:text-neutral-900 hover:underline">
                            Отмена
                        </Link>
                    </div>
                </form>
