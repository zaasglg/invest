    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            <div className="flex h-full flex-col p-6">
                <h1 className="mb-6 text-2xl font-bold text-[#0f1b3d]">Жаңа ИА</h1>
                ...
                <form onSubmit={submit} className="flex flex-1 flex-col">
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                            <div className="mb-6">
                                ...
                                <p className="text-sm text-gray-500">
                                    Индустриялық аймақ туралы негізгі мәліметтерді толтырыңыз.
                                </p>
                            </div>
                    ...
                    {currentStep === 2 && (
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                            <div className="space-y-6">
                                <div className="rounded-lg border border-gray-200 bg-white p-6">
                                    <div className="mb-4">
                                        <h2 className="text-lg font-semibold text-[#0f1b3d]">Сипаттама</h2>
                                    </div>
                                    <Textarea
                                        id="description"
                                        value={data.description}
                                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setData('description', e.target.value)}
                                        className="min-h-[120px] border-gray-200 bg-transparent shadow-none focus-visible:ring-0 focus:border-[#0f1b3d]"
                                ...
                                <div className="rounded-lg border border-gray-200 bg-white p-6">
                                    <div className="mb-4">
                                        <h2 className="text-lg font-semibold text-[#0f1b3d]">Инфрақұрылым</h2>
                                    </div>
                                    <InfrastructureForm
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-6">
                                <div className="mb-4">
                                    <h2 className="text-lg font-semibold text-[#0f1b3d]">Орналасу (полигон)</h2>
                                </div>
                                <LocationPicker
                                    value={data.location}
                    ...
                    {currentStep === 3 && (
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                            <div className="mb-6">
                                <h2 className="text-lg font-semibold text-[#0f1b3d]">Деректерді тексеріңіз</h2>
                                <p className="text-sm text-gray-500">
                                    Енгізілген мәліметтерді тексеріп, растаңыз.
                                </p>
                            </div>
