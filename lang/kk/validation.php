...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'password' => 'Құпиясөз',
        'role_id' => 'Рөл',
        'parent_id' => 'Облыс аймағы',
        'color' => 'Түс',
        'icon_file' => 'Иконка файлы',
        'area' => 'Алаң',
        'type' => 'Тип',
        'subtype' => 'Подтип',
        'geometry' => 'Геометрия',
        ...
        'actual_address' => 'Шынайы мекенжай',
        'iin' => 'ЖСН',
        'bin' => 'БИН',
        'bik' => 'БИК',
        'bank_name' => 'Банк атауы',
        'bank_account' => 'Банк шоты',
        'bank_correspondent_account' => 'Банк корреспонденттік шоты',
        'bank_identification_code' => 'Банк идентификациялық коды',
        'bank_swift_code' => 'Банк SWIFT коды',
